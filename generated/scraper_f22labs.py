...
SCRAPER_PLAN = json.loads("""{
  "company_domain": "f22labs.com",
  "company_slug": "f22labs",
  "target_country_code": "IN",
  "transport": "rest",
  "start_urls": [
    "https://f22labs.zohorecruit.in/jobs/Careers/",
    "https://f22labs.zohorecruit.in/jobs/Careers/",
    "https://f22labs.com/careers",
    "https://f22labs.com/jobs",
    "https://f22labs.com/join-us",
    "https://f22labs.com/vacancies",
    "https://f22labs.com/work-with-us",
    "https://f22labs.zohorecruit.in/jobs/Careers/",
    "https://www.f22labs.com/careers",
    "https://www.f22labs.com/jobs",
    "https://www.f22labs.com/join-us",
    "https://www.f22labs.com/vacancies",
    "https://www.f22labs.com/work-with-us"
  ],
  "api_endpoint": null,
        ...
        with sync_playwright() as p:
            ...
            for start_url in self._start_urls():
                ...
                if items:
                    ...
                    records.extend(self._records_from_html_items(soup.select(item_selector), page.url))
            browser.close()
        return records, {"pagination_complete": True}
